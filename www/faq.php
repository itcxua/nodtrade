<?php
$title="Часто задаваемые вопросы | Автомобильные грузоперевозки в Украине  - ФЛП Егоров Д.В.";
$css_name="faq";
  ...
  <header class="page">
            ...
            <div class="container">
                <div class="page_card d-flex flex-column">
                    <h1 class="page_card-title">FAQs</h1>
                    <ul class="page_card-breadcrumbs breadcrumbs">
                        ...
                        <li class="page_card-breadcrumbs_item item">
                            <span class="current">Вопросы - ответы</span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <main class="faq section">
            <div class="container">
                <div class="faq_main d-md-flex justify-content-between align-items-start">
                    <div class="faq_main-accordion" id="faq_accordion">
                        <!-- item 1 -->
                        <div class="faq_main-accordion_item">
                            <div class="item-wrapper">
                                <h6
                                    ...
                                    aria-expanded="true"
                                >
                                    <span class="title_text"> The right price for you, whoever you are? </span>
                                    <span class="title_icon transform">
                                        <i class="icon-chevron_down--entypo"></i>
                                    </span>
                                </h6>
                                <div id="item-1" class="accordion-collapse collapse show" data-bs-parent="#faq_accordion">
                                    <div class="body">
                                        <div class="main">
                                            <p class="main_text">
                                                Etiam id quam lacinia, vulputate neque nec, mollis quam. Donec ut quam urna. Proin bibendum
                                                risus quis sem ultricies, et vulputate erat pulvinar. Cras posuere leo nisi, non scelerisque
                                                tortor congue nec. Vivamus quis urna ac velit dapibus bibendum vitae a nibh. Suspendisse id
                                                libero eros. In dapibus bibendum sem sit amet feugiat.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="faq_main-accordion_item">
                            <div class="item-wrapper">
                                ...
                                <div id="item-2" class="accordion-collapse collapse" data-bs-parent="#faq_accordion">
                                    <div class="body">
                                        <div class="main">
                                            <p class="main_text">
                                                Etiam id quam lacinia, vulputate neque nec, mollis quam. Donec ut quam urna. Proin bibendum
                        ...
                        <div class="faq_main-accordion_item">
                            <div class="item-wrapper">
                                <h6
                                    ...
                                    aria-expanded="false"
                                >
                                    <span class="title_text"> Transporterium is the biggest company </span>
                                    <span class="title_icon">
                                        <i class="icon-chevron_down--entypo"></i>
                                    </span>
                                </h6>
                                <div id="item-3" class="accordion-collapse collapse" data-bs-parent="#faq_accordion">
                                    <div class="body">
                                        <div class="main">
                                            <p class="main_text">
                                                Etiam id quam lacinia, vulputate neque nec, mollis quam. Donec ut quam urna. Proin bibendum
                        ...
                        <div class="faq_main-accordion_item">
                            <div class="item-wrapper">
                                <h6
                                    ...
                                    aria-expanded="false"
                                >
                                    <span class="title_text"> Powerfull Features of Transporterium </span>
                                    <span class="title_icon">
                                        <i class="icon-chevron_down--entypo"></i>
                                    </span>
                                </h6>
                                <div id="item-4" class="accordion-collapse collapse" data-bs-parent="#faq_accordion">
                                    <div class="body">
                                        <div class="main">
                                            <p class="main_text">
                                                Etiam id quam lacinia, vulputate neque nec, mollis quam. Donec ut quam urna. Proin bibendum
                        ...
                        <div class="faq_main-accordion_item">
                            <div class="item-wrapper">
                                <h6
                                    ...
                                    aria-expanded="false"
                                >
                                    <span class="title_text"> Awesome app which works for you </span>
                                    <span class="title_icon">
                                        <i class="icon-chevron_down--entypo"></i>
                                    </span>
                                </h6>
                                <div id="item-5" class="accordion-collapse collapse" data-bs-parent="#faq_accordion">
                                    <div class="body">
                                        <div class="main">
                                            <p class="main_text">
                                                Etiam id quam lacinia, vulputate neque nec, mollis quam. Donec ut quam urna. Proin bibendum
                    ...
                    <ul class="contact_data">
                        <li class="contact_data-item">
                            ...
                            <div class="main">
                                <span class="main_title">Телефоны</span>
                                <div class="main_info">
                                    <a class="link h6" href="tel:+380674105077">067 410-50-77</a>
                                    <a class="link h6" href="tel:+380975054896">097 505-48-96</a>
                                </div>
                            </div>
                        </li>
                        <li class="contact_data-item">
                        ...
                        <li class="contact_data-item">
                            ...
                            <div class="main">
                                 <span class="main_title">Telegram</span>
                                <div class="main_info">
                                    <a class="link h6" href="https://t.me/DmitriyLogist">@DmitriyLogist</a>
                ...
                <section class="banner">
                    <div class="container">
                        <span class="banner_bg">
                            <picture>
                                <source data-srcset="img/beck2.webp" srcset="img/beck2.webp" />
                                <img class="lazy" data-src="img/beck2.webp" src="img/beck2.webp" alt="media" />
                            </picture>
                        ...
                        <div class="banner_content">
                            ...
                            <p class="banner_content-text">
                               Наша компания предоставляет широкий спектр услуг по перевозке грузов, включая перевозки насыпных, наливных, полетных грузов.
                            </p>
