<?php
$title="Контакты | Автомобильные грузоперевозки в Украине  - ФЛП Егоров Д.В.";
$css_name="contacts";
        ...
        <header class="page">
            ...
            <div class="container">
                <div class="page_card d-flex flex-column">
                    <h1 class="page_card-title">Контакты</h1>
                        ...
                        <div class="contacts_main-card d-flex flex-column justify-content-end">
                            ...
                            <div class="content">
                                <h4 class="contacts_main-card_title">
                                    <span class="d-block">Наши</span>
                                    <span class="d-block">услуги</span>
                                </h4>
                                <a class="contacts_main-card_btn btn btn--split" href="<?=URL?>/services">
                                    <span class="main">Подробнее</span>
