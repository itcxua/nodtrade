            ...
            <div class="container">
                <div class="footer_main d-md-flex flex-wrap justify-content-between">
                    <div class="footer_main-block footer_main-block--about">
                        ...
                        <p class="text">
                           Надійний партнер у сфері логістики. Ми надаємо повний комплекс послуг з доставки вантажів. Ми використовуємо сучасні технології та інновації для забезпечення високої якості наших послуг.</p>
                    </div>
                    <div class="footer_main-block footer_main-block--nav">
                        <ul class="list d-flex flex-column">
                            <li class="list-item">
                                <i class="icon-caret_right icon"></i>
                                <a class="link" href="<?=URL?>/about/ua">Про нас</a>
                            </li>
                            <li class="list-item">
                                <i class="icon-caret_right icon"></i>
                                <a class="link" href="<?=URL?>/calculator/ua">Калькулятор тарифів</a>
                            </li>
                          
                             <li class="list-item">
                                <i class="icon-caret_right icon"></i>
                                <a class="link" href="<?=URL?>/transportation_bulk_cargo/ua">Перевезення насипних вантажів</a>
                            </li>
                          <li class="list-item">
                                <i class="icon-caret_right icon"></i>
                                <a class="link" href="<?=URL?>/transportation_liquid_cargo/ua">Перевезення наливних вантажів</a>
                            </li>
                             <li class="list-item">
                                <i class="icon-caret_right icon"></i>
                                <a class="link" href="<?=URL?>/transportation_complete_cargo/ua">Перевезення комплектний вантаж</a>
                            </li>
                             <li class="list-item">
                                <i class="icon-caret_right icon"></i>
                                <a class="link" href="<?=URL?>/transportation_project_cargo/ua">Проектні перевезення</a>
                            </li>
                   ...
                   <div class="footer_main-block footer_main-block--subscribe">
                        <h5 class="title">  <a class="link" href="<?=URL?>/contacts/ua">Наші контакти</a></h5>
                      <b>Телефон</b>
                ...
                <ul class="footer_info d-md-flex flex-wrap">
                    ...
                    <li class="footer_info-block footer_info-block--highlight">
                        <div class="main">
                            <span class="main_label">Адреса</span>
                            <span class="main_info">08130 Київська область, с. Чайки, вул. Авіаконструктора Антонова 1</span>
                        </div>
                    </li>
                    <li class="footer_info-block">
                        <div class="main">
                ...
                <p class="footer_copyrights">ФОП Єгоров Д.В.<span id="currentYear"></span></p>
            </div>
        </footer>
...
$(document).ready(function(){
    ...
    $('#forma').on('submit', function(event) {
        ...
        if (!name) {
            isValid = false;
            errorMessage += 'Поле "ПІБ" не повинно бути порожнім.\n';
        }
        ...
        if (!phone.match(phonePattern)) {
            isValid = false;
            errorMessage += 'Телефон повнен бути в форматі +38(099)999-99-99.\n';
        }
        ...
        if (!email.match(emailPattern)) {
            isValid = false;
            errorMessage += 'Електронна пошта має невірний формат.\n';
        }

        // Перевірка теми
        if (!tema) {
            isValid = false;
            errorMessage += 'Поле "Тема" не повинно бути порожнім.\n';
        }

        // Перевірка повідомлення
        if (!msg) {
            isValid = false;
            errorMessage += 'Поле "Повідомлення" не повинно бути порожнім.\n';
        }
        ...
        if (!isValid) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#formMessage').removeClass('error').addClass('success').text('Ваше повідомлення  успішно надіслано!').slideDown();
                    $('#forma')[0].reset(); // Очистити форму після успішної відправки
                },
                error: function() {
                    $('#formMessage').removeClass('success').addClass('error').text('Виникла помилка при відправці повідомлення. Спробуйте будь ласка еще раз.').slideDown();
                }
            });
        }
    });
