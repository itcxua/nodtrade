<?php
$title="Контакти Автомобільні вантажні перевезення в Україні  - ФОП Єгоров Д.В.";
        ...
        <header class="page">
            ...
            <div class="container">
                <div class="page_card d-flex flex-column">
                    <h1 class="page_card-title">Контакти</h1>
...
?> 
            <div class="contacts_main section">
                <div class="container">
                    <ul class="contact_data">
                        <li class="contact_data-item">
                            ...
                            <div class="main">
                                ...
                                <div class="main_info">
                                    <a class="link h6" href="tel:+380674105077">+38 (067) 410-50-77</a><br>
 ...
 <span class="h6"> вул. Авіаконструктора Антонова 1</span>
                        ...
                        <li class="contact_data-item">
                            ...
                            <div class="main">
                                ...
                                <div class="main_info">
                                    <a class="link h6" href="mailto:info@logisticstoUkraine.com">info@logisticstoUkraine.com</a>
                                </div><br>
            ...
            <button class="btn btn--regular" type="submit">Відправити</button>
                        ...
                        <div class="contacts_main-card d-flex flex-column justify-content-end">
                            <span class="contacts_main-card_bg">
                                <picture>
                            ...
                            <div class="content">
                                <h4 class="contacts_main-card_title">
                                    <span class="d-block">Наші</span>
                                    <span class="d-block">послуги</span>
                                </h4>
                                <a class="contacts_main-card_btn btn btn--split" href="<?=URL?>/services/ua">
                                    <span class="main">Детальніше</span>
