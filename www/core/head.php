...
<!-- End Google Tag Manager (noscript) -->
                ...
                <div class="container d-flex flex-wrap flex-lg-nowrap align-items-center justify-content-between flex-lg-row-reverse">
                    ...
                    <div class="header_nav-wrapper collapse" id="headerMenu">
                        <ul class="header_nav-menu d-flex flex-column flex-lg-row">
                            ...
                            <li class="header_nav-menu_item">
                                <a class="nav-item nav-link" href="<?=URL?>/about" data-page="about">О нас</a>
                            </li>
    ...
    <div class="dropdown-menu collapse" id="blogMenu">
        <ul class="dropdown-list"> <li class="list-item">
                <a class="dropdown-item nav-item d-flex align-items-center" data-page="post" href="<?=LangUrl('ua');?>">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Flag_of_Ukraine.svg/2560px-Flag_of_Ukraine.svg.png" alt="Ukrainian" style="width: 20px; margin-right: 8px;" />Украинский
                </a>
            </li>
            <li class="list-item">
                <a class="dropdown-item nav-item d-flex align-items-center" data-page="post" href="<?=LangUrl(null,'ua');?>">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Flag_of_Russia.svg/2560px-Flag_of_Russia.svg.png" alt="Russian" style="width: 20px; margin-right: 8px;" />Русский
                </a>
            </li>
